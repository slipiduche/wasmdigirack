...
import { sportscollection} from "../../nftcollections";
        ...
        <div className="bg-white"> 
            <div className="lg:container mx-auto px-4">
                <div className="mb-[84px] w-full h-[220px] max-h-full max-w-full overflow-hidden flex justify-center items-center relative collection_cover">
                    <img src = {require('../../images/collections/sportscover.png')} alt = 'sports banner' className="h-full w-full object-cover" />
                </div>
                <div className='flex flex-col items-center justify-center mb-[20px]'>
                    <h1 className='text-3xl lg:text-4xl font-[600] leading-60px text-center mb-[35px]'>Explore Sports</h1>
            ...
            <div className="border-t-[1px] border-gray-300">
                <div className="lg:container mx-auto px-4">
                    <h1 className='text-[20px] lg:text-[24px] font-[600] text-center py-8 my-3'>Trending Collections in Sports</h1>
                </div>
            </div>
