        ...
        <div className="bg-white"> 
            <div className="lg:container mx-auto px-4">
                ...
                <div className='flex flex-col items-center justify-center mb-[20px]'>
                    <h1 className='text-3xl lg:text-4xl font-[600] leading-60px text-center mb-[35px]'>Explore Music</h1>
            ...
            <div className="border-t-[1px] border-gray-300">
                <div className="lg:container mx-auto px-4">
                    <h1 className='text-[20px] lg:text-[24px] font-[600] text-center py-8 my-3'>Trending Collections in Music</h1>
                </div>
            </div>
