          ...
          {asset.details.onchainMetadata ? (
            <div
              className={
                column_className
                  ? column_className
                  : "column is-one-full-mobile is-half-tablet one-quarter-desktop is-one-quarter-widescreen is-one-quarter-fullhd"
              }
            >
              <Link
                to={`/assets/${asset.details.policyId}/${asset.details.asset}`}
              >
                        ...
                        {show_offer ? (
                          asset.offers ? (
                            Object.keys(asset.offers).length ? (
                              <span
                                className="tag is-warning is-medium is-rounded price_tag"
                                style={{ top: "50px" }}
                              >
